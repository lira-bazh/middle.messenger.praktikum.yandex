...
interface UsersIconProps extends BlockProps {
  onClick?: (e: Event) => void;
}

export class UsersIcon extends Block {
  constructor(props: UsersIconProps) {
    super({
      ...props,
      events: {
  ...
  override render(): string {
    return `
    <svg class="icon users-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
