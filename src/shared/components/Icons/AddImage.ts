...
interface AddImageIconProps extends BlockProps {
  onClick?: (e: Event) => void;
}

export class AddImageIcon extends Block {
  constructor(props: AddImageIconProps) {
    super({
      ...props,
      events: {
  ...
  override render(): string {
    return `
    <svg class="icon add-image-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
