...
interface TrashIconProps extends BlockProps {
  onClick?: (e: Event) => void;
}

export class TrashIcon extends Block {
  constructor(props: TrashIconProps) {
    super({
      ...props,
      events: {
  ...
  override render(): string {
    return `
    <svg class="icon trash-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
